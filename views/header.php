                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="views/edit-user.php"><i class=" fa fa-suitcase"></i>Hồ Sơ</a></li>
                            <li><a href="views/login.php"><i class="fa fa-cog"></i> Đăng Nhập</a></li>
                            <li><a href="logout.php"><i class="fa fa-bell-o"></i> Đăng Xuất</a></li>
