...
<head>
    ...
    <title>Danh Sách Bình Luận Chưa Trả Lời</title>
                        ...
                        <tbody>
                           ...
                           <?php foreach($comment as $t):?>
                            <tr id="sanpham-<?= $t->id?>">
                                ...
                                <td><?=$t->name?></td>
                                <td>
                                    <a style=" padding-bottom:10px" href="views/rep-comment.php?id=<?= $t->id?>"><button class="btn btn-warning btn-sm" style="width:100%;">Trả Lời</button></a>
                                </td>
                            </tr>
                            <?php endforeach?>
                        </tbody>
