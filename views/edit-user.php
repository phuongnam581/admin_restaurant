<?php
    session_start();
    include_once('C:\xampp\htdocs\admin_nhahang\model\EditUserModel.php');
    $model= new EditUserModel;
    $user=$model->getUser($_SESSION['name']);
    if(isset($_POST['submit'])){
        $pass=$_POST['pass'];
        $phone=$_POST['phone'];
        $check=$model->updateUser($_SESSION['name'],$pass,$phone);
        if($check){
        ...
        <section class="content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <b>Sửa thông tin người dùng: <span style="color:blue"><?= $user->username?></span></b>
                </div>
                   ...
                   <?php if(isset($_SESSION['message'])):?>
                    ...
                    <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="pass" placeholder="Nhập mật khẩu" required value="<?= $user->password?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2">Điện Thoại:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="phone" placeholder="Nhập điện thoại" required value="<?= $user->phone?>">
                            </div>
                        </div>
                        <div class="form-group">
